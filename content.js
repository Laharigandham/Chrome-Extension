...
function addBookmarkButton(){
    ...
    const myHeading=document.getElementsByClassName("coding_problem_info_heading__G9ueL")[0];

    myHeading.parentNode.insertAdjacentElement("afterend",bookmarkButton);
...
async function addNewBookmarkHandler() {
    ...
    const problemName = document.getElementsByClassName("coding_problem_info_heading__G9ueL fw-bolder rubik fs-4 mb-0")[0].innerText;
